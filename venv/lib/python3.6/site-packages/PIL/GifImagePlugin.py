...
def _write_single_frame(im, fp, palette):
    ...
    ImageFile._save(im_out, fp, [("gifs", (0, 0)+im.size, 0,
                                  RAWMODE[im_out.mode])])
...
def _get_palette_bytes(im):
    """
    Gets the palette for inclusion in the gifs header

    :param im: Image object
    :returns: Bytes, len<=768 suitable for inclusion in gifs header
    """
...
def _write_frame_data(fp, im_frame, offset, params):
    try:
        ...
        ImageFile._save(im_frame, fp, [("gifs", (0, 0)+im_frame.size, 0,
...
def getdata(im, offset=(0, 0), **params):
    ...
    :returns: List of Bytes containing gifs encoded frame data
...
Image.register_extension(GifImageFile.format, ".gifs")
Image.register_mime(GifImageFile.format, "image/gifs")
